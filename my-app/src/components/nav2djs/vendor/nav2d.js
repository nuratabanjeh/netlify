...
NAV2D.Navigator = function(options) {
    ...
    var poseListener = new ROSLIB.Topic({
        ros: ros,
        name: '/amcl_pose', //'/robot_pose',
        messageType: 'geometry_msgs/PoseWithCovarianceStamped', //'geometry_msgs/Pose',
        throttle_rate: 1
    });

    poseListener.subscribe(function(pose1) {
        var pose = pose1.pose.pose;
